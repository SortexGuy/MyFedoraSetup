...
sudo dnf install xorg-x11-server-Xorg xorg-x11-xinit network-manager-applet\
 ...
 gvfs lightdm-gtk xfwm4 NetworkManager-wifi mousepad thunar -y; # Required packages for XFCE desktop
...
sudo yum -y install uim uim-gtk3 && imsettings-switch -q uim;
